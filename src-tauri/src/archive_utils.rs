            ...
            let type_name = if is_dir {
                "Folder".to_string() // Use "Folder" for consistency
                 ...
                 match ext.to_lowercase().as_str() {
                    ...
                    "dll" => "Application Extension".to_string(),
                    "ini" | "cfg" | "conf" | "json" | "xml" | "yaml" | "toml" => "Configuration File".to_string(),
                    "log" => "Log File".to_string(),
                    "md" => "Markdown File".to_string(),
                    "html" | "htm" => "HTML Document".to_string(),
                    "css" => "Stylesheet".to_string(),
                    "js" | "ts" => "Script File".to_string(),
                    "py" => "Python Script".to_string(),
                    "java" => "Java Source File".to_string(),
                    "c" | "cpp" | "h" => "C/C++ Source File".to_string(),
                    "cs" => "C# Source File".to_string(),
                    "sh" => "Shell Script".to_string(),
                    "bat" => "Batch Script".to_string(),
                    "mp3" | "wav" | "ogg" | "flac" => "Audio File".to_string(),
                    "mp4" | "mkv" | "avi" | "mov" | "wmv" => "Video File".to_string(),
                    "iso" => "Disk Image".to_string(),
                    _ => format!("{} File", ext.to_uppercase()), // Default for unknown extensions
                }
            } else {
